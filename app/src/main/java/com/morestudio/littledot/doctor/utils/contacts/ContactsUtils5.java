...
package com.morestudio.littledot.doctor.utils.contacts;
...
public class ContactsUtils5 extends ContactsWrapper {
            ...
            try {
                if (cursor.getCount() > 0) {
                    ...
                    if (cv.containsKey(PhoneLookup.TYPE) && cv.containsKey(PhoneLookup.LABEL)) {
                        ...
                        callerInfo.phoneLabel = (String) CommonDataKinds.Phone
    ...
    /* (non-Javadoc)
     * @see com.morestudio.littledot.doctor.utils.contacts.ContactsWrapper#isExternalPhoneNumber(android.content.Context, android.database.Cursor)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.morestudio.littledot.doctor.utils.contacts.ContactsWrapper#bindContactPhoneView(android.view.View, android.content.Context, android.database.Cursor)
     */
    @Override
    public void bindContactPhoneView(View view, Context context, Cursor cursor) {
        ...
        if(CommonDataKinds.Phone.CONTENT_ITEM_TYPE.equalsIgnoreCase(mimeType)) {
            ...
            if(labelColumnIdx != -1 && typeColumnIdx != -1) {
                ...
                labelName = CommonDataKinds.Phone.getTypeLabel(context.getResources(), typeField, labelField);
            }
            ...
            if(typeColumnIdx != -1 && labelColumnIdx != -1) {
                String labelField = cursor.getString(labelColumnIdx);
                int typeField = cursor.getInt(typeColumnIdx);
                labelName = CommonDataKinds.Im.getProtocolLabel(context.getResources(), typeField, labelField);
            }
        }
