...
package com.morestudio.littledot.doctor.ui.incall;
...
import com.morestudio.littledot.doctor.api.MediaState;
import com.morestudio.littledot.doctor.api.SipCallSession;
import com.morestudio.littledot.doctor.api.SipCallSession.StatusCode;
...
import com.morestudio.littledot.doctor.ui.PickupSipUri;
import com.morestudio.littledot.doctor.ui.incall.CallProximityManager.ProximityDirector;
import com.morestudio.littledot.doctor.ui.incall.DtmfDialogFragment.OnDtmfListener;
import com.morestudio.littledot.doctor.ui.incall.locker.IOnLeftRightChoice;
import com.morestudio.littledot.doctor.ui.incall.locker.InCallAnswerControls;
import com.morestudio.littledot.doctor.ui.incall.locker.ScreenLocker;
import com.morestudio.littledot.doctor.utils.CallsUtils;
...
import com.morestudio.littledot.doctor.utils.keyguard.KeyguardWrapper;
...
public class InCallActivity extends SherlockFragmentActivity implements IOnCallActionTrigger, 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        wakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK
                ...
                "com.morestudio.littledot.doctor.onIncomingCall");
    ...
    private void attachVideoPreview() {
        ...
        if(prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_VIDEO)) {
            ...
            if(videoWakeLock == null) {
                videoWakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "com.morestudio.littledot.doctor.videoCall");
