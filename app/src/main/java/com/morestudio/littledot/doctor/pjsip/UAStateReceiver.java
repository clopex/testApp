...
import com.morestudio.littledot.doctor.service.SipNotifications;
...
import com.morestudio.littledot.doctor.service.impl.SipCallSessionImpl;
import com.morestudio.littledot.doctor.utils.CallLogHelper;
import com.morestudio.littledot.doctor.utils.Compatibility;
import com.morestudio.littledot.doctor.utils.Log;
import com.morestudio.littledot.doctor.utils.Threading;
    ...
    public void initService(PjSipService srv) {
        ...
        if (eventLock == null) {
            ...
            eventLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK,
                    "com.morestudio.littledot.doctor.inEventLock");
        ...
        if (ongoingCallLock == null) {
            ...
            ongoingCallLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK,
                    "com.morestudio.littledot.doctor.ongoingCallLock");
