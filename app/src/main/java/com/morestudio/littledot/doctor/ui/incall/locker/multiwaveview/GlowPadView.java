...
package com.morestudio.littledot.doctor.ui.incall.locker.multiwaveview;
...
import com.morestudio.littledot.doctor.ui.incall.locker.IOnLeftRightChoice;
import com.morestudio.littledot.doctor.ui.incall.locker.IOnLeftRightChoice.IOnLeftRightProvider;
import com.morestudio.littledot.doctor.ui.incall.locker.IOnLeftRightChoice.TypeOfLock;
...
public class GlowPadView extends View implements IOnLeftRightProvider {
    private static final String THIS_FILE = "GlowPadView";
    ...
    private IOnLeftRightChoice mOnLeftRightListener;
    ...
    public GlowPadView(Context context, AttributeSet attrs) {
        ...
        //mHandleDrawable = new TargetDrawable(res, handle != null ? handle.resourceId : R.drawable.ic_in_call_touch_handle);
        mHandleDrawable = new TargetDrawable(res, R.drawable.ic_in_call_touch_handle);
        mHandleDrawable.setState(TargetDrawable.STATE_INACTIVE);
        mOuterRing = new TargetDrawable(res, R.drawable.ic_lockscreen_outerring);
        ...
        mGravity = a.getInt(R.styleable.GlowPadView_gravity, Gravity.CENTER);
...
//    }
    ...
    private void computeInsets(int dx, int dy) {
        final int absoluteGravity = getAbsoluteGravity();
...
//        return Gravity.getAbsoluteGravity(mGravity, layoutDirection);
        return mGravity;
    }
    ...
    private String getTargetDescription(int index) {
        if (mTargetDescriptions == null || mTargetDescriptions.isEmpty()) {
            ...
            if (mTargetDrawables.size() != mTargetDescriptions.size()) {
                Log.w(THIS_FILE, "The number of target drawables must be"
    ...
    /* (non-Javadoc)
     * @see com.morestudio.littledot.doctor.widgets.IOnLeftRightChoice.IOnLeftRightProvider#setOnLeftRightListener(com.morestudio.littledot.doctor.widgets.IOnLeftRightChoice)
     */
    @Override
    public void setOnLeftRightListener(IOnLeftRightChoice l) {
        mOnLeftRightListener = l;
    }

    /* (non-Javadoc)
     * @see com.morestudio.littledot.doctor.ui.incall.locker.IOnLeftRightChoice.IOnLeftRightProvider#applyTargetTitles(int)
     */
    @Override
    public void applyTargetTitles(int resArrayTitles) {
        setTargetDescriptionsResourceId(resArrayTitles);
    }

    /* (non-Javadoc)
     * @see com.morestudio.littledot.doctor.ui.incall.locker.IOnLeftRightChoice.IOnLeftRightProvider#setTypeOfLock(com.morestudio.littledot.doctor.ui.incall.locker.IOnLeftRightChoice.TypeOfLock)
     */
    @Override
    public void setTypeOfLock(TypeOfLock lock) {
        ...
        Drawable pointDrawable = getResources().getDrawable(R.drawable.ic_lockscreen_glowdot);
    ...
    /* (non-Javadoc)
     * @see com.morestudio.littledot.doctor.ui.incall.locker.IOnLeftRightChoice.IOnLeftRightProvider#getLayoutingHeight()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.morestudio.littledot.doctor.ui.incall.locker.IOnLeftRightChoice.IOnLeftRightProvider#getLayoutingWidth()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.morestudio.littledot.doctor.ui.incall.locker.IOnLeftRightChoice.IOnLeftRightProvider#resetView()
     */
    @Override
