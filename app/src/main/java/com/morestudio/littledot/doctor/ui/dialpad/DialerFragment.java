...
package com.morestudio.littledot.doctor.ui.dialpad;
...
import com.morestudio.littledot.doctor.ui.SipHome.ViewPagerVisibilityListener;
import com.morestudio.littledot.doctor.ui.dialpad.DialerLayout.OnAutoCompleteListVisibilityChangedListener;
import com.morestudio.littledot.doctor.utils.CallHandlerPlugin;
import com.morestudio.littledot.doctor.utils.CallHandlerPlugin.OnLoadListener;
import com.morestudio.littledot.doctor.utils.DialingFeedback;
import com.morestudio.littledot.doctor.utils.Log;
import com.morestudio.littledot.doctor.utils.PreferencesWrapper;
import com.morestudio.littledot.doctor.utils.Theme;
import com.morestudio.littledot.doctor.utils.contacts.ContactsSearchAdapter;
import com.morestudio.littledot.doctor.widgets.AccountChooserButton;
import com.morestudio.littledot.doctor.widgets.AccountChooserButton.OnAccountChangeListener;
import com.morestudio.littledot.doctor.widgets.DialerCallBar;
import com.morestudio.littledot.doctor.widgets.DialerCallBar.OnDialActionListener;
import com.morestudio.littledot.doctor.widgets.Dialpad;
import com.morestudio.littledot.doctor.widgets.Dialpad.OnDialKeyListener;
    ...
    public void placeVMCall() {
        ...
        if (accountToUse >= 0) {
            ...
            if (!TextUtils.isEmpty(vmAcc.vm_nbr)) {
                ...
                (new ComponentName(getActivity(), com.morestudio.littledot.doctor.plugins.telephony.CallHandler.class).flattenToString()))) {
            // Case gsm voice mail
