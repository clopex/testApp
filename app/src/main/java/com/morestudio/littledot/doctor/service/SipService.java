...
import com.morestudio.littledot.doctor.api.ISipConfiguration;
...
import com.morestudio.littledot.doctor.api.SipMessage;
...
import com.morestudio.littledot.doctor.pjsip.PjSipCalls;
import com.morestudio.littledot.doctor.pjsip.PjSipService;
import com.morestudio.littledot.doctor.pjsip.UAStateReceiver;
import com.morestudio.littledot.doctor.service.receiver.DynamicReceiver4;
import com.morestudio.littledot.doctor.service.receiver.DynamicReceiver5;
import com.morestudio.littledot.doctor.ui.incall.InCallMediaControl;
...
import com.morestudio.littledot.doctor.utils.ExtraPlugins.DynActivityPlugin;
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	private void applyComponentEnablingState(boolean active) {
        ...
        ComponentName cmp = new ComponentName(this, "com.morestudio.littledot.doctor.ui.PrivilegedOutgoingCallBroadcaster");
        try {
	...
	private synchronized void acquireResources() {
		...
		if (prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_PARTIAL_WAKE_LOCK)) {
			...
			if (wakeLock == null) {
				wakeLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.morestudio.littledot.doctor.SipService");
		...
		if (wifiLock == null) {
			...
			wifiLock = wman.createWifiLock(mode, "com.morestudio.littledot.doctor.SipService");
