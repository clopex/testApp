...
package com.morestudio.littledot.doctor.widgets.contactbadge;
...
public class ContactBadge5 extends ContactBadgeContract {
    ...
    public ContactBadge5(Context context, AttributeSet attrs, int defStyle, com.morestudio.littledot.doctor.widgets.contactbadge.QuickContactBadge topBadge) {
