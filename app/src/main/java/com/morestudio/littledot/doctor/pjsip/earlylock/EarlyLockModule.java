...
package com.morestudio.littledot.doctor.pjsip.earlylock;
...
import com.morestudio.littledot.doctor.pjsip.PjSipService.PjsipModule;
...
public class EarlyLockModule implements PjsipModule {
     ...
     * (non-Javadoc)
     * @see
     * com.morestudio.littledot.doctor.pjsip.PjSipService.PjsipModule#setContext(android.content
     * .Context)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.morestudio.littledot.doctor.pjsip.PjSipService.PjsipModule#onBeforeStartPjsip()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.morestudio.littledot.doctor.pjsip.PjSipService.PjsipModule#
     * onBeforeAccountStartRegistration(int, com.morestudio.littledot.doctor.api.SipProfile)
     */
    @Override
    ...
    private class WorkLocker extends Thread {
        ...
        WorkLocker(long time) {
            lockTime = time;
            wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.morestudio.littledot.doctor.earlylock");
            wl.acquire();
        }
