...
public class Kurira extends SimpleImplementation {
	...
	public void fillLayout(final SipProfile account) {
		...
		accountUsername.setDialogMessage("13 digits long in international format : +#############");
	...
	public String getDefaultFieldSummary(String fieldName) {
		if(fieldName.equals(USER_NAME)) {
			return "13 digits long in international format : +#############";//parent.getString(R.string.w_common_phone_number_desc);
		}
