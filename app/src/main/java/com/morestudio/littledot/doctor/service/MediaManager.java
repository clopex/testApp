...
import com.morestudio.littledot.doctor.utils.Ringer;
import com.morestudio.littledot.doctor.utils.accessibility.AccessibilityWrapper;
import com.morestudio.littledot.doctor.utils.audio.AudioFocusWrapper;
import com.morestudio.littledot.doctor.utils.bluetooth.BluetoothWrapper;
import com.morestudio.littledot.doctor.utils.bluetooth.BluetoothWrapper.BluetoothChangeListener;
		...
		*/
		...
		if(wifiLock == null) {
			wifiLock = wman.createWifiLock( 
							...
							"com.morestudio.littledot.doctor.InCallLock");
		...
		if(winfo != null) {
			...
			if(service.getPrefs().getPreferenceBooleanValue(SipConfigManager.KEEP_AWAKE_IN_CALL)) {
				if(screenLock == null) {
		            ...
		            screenLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "com.morestudio.littledot.doctor.onIncomingCall.SCREEN");
