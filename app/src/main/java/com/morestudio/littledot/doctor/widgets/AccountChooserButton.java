...
package com.morestudio.littledot.doctor.widgets;
...
import com.morestudio.littledot.doctor.utils.AccountListUtils;
import com.morestudio.littledot.doctor.utils.AccountListUtils.AccountStatusDisplay;
...
public class AccountChooserButton extends LinearLayout implements OnClickListener, View_HasStateListenerSupport {
    ...
    public AccountChooserButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        telCmp = new ComponentName(getContext(), com.morestudio.littledot.doctor.plugins.telephony.CallHandler.class);
