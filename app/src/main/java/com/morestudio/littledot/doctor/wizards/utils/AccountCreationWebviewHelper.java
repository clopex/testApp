    ...
    public static AccountCreationWebviewHelper getInstance() {
        if(instance == null) {
            if(Compatibility.isCompatible(8)) {
                instance = new com.morestudio.littledot.doctor.wizards.utils.AccountCreationWebviewHelper8();
            }else {
                instance = new com.morestudio.littledot.doctor.wizards.utils.AccountCreationWebviewHelper3();
            }
        }
